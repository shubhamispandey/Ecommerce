                      ...
                      <button
                        onClick={async () => {
                          ...
                          try {
                            ...
                            if (!cartItemId) {
                              console.error("Missing cart item ID for cart update", item);
                              return;
                            }
                            ...
                            if (quantity > 0) {
                              ...
                              await dispatch(
                                optimisticDeleteItem({ cartItemId }),
                              ).unwrap();
                            }
                          } catch (error) {
                            console.error(error);
                  ...
                  <button
                    onClick={async () => {
                      ...
                      try {
                        const cartItemId = item.id ?? item.productId;
                        if (!cartItemId) {
                          console.error("Missing cart item ID for cart delete", item);
                          return;
                        }
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600 transition disabled:opacity-50 disabled:cursor-not-allowed
                              }),
                            ).unwrap();
                          } catch (error) {
                            console.error(error);
